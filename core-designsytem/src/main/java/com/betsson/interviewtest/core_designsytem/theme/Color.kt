package com.betsson.interviewtest.core_designsytem.theme
...
val md_theme_light_tertiary = Color(0xFFDFE6F1)
...
//val md_theme_light_background = Color(0xffFDFAF4)
...
val md_theme_dark_primary = Color(0xFF9F8C76)

//val md_theme_dark_onPrimary = Color(0xFFFFFFFF)
val md_theme_dark_primaryContainer = Color(0xFF363636)
...
val md_theme_dark_background = Color(0xFF6C685F)

//val md_theme_dark_onBackground = Color(0xFFE6E1E5)
//val md_theme_dark_surface = Color(0xFF141414)
val md_theme_dark_onSurface = Color(0xFF121212)
//val md_theme_dark_surfaceVariant = Color(0xFF333333)
//val md_theme_dark_onSurfaceVariant = Color(0xFFCAC4D0)
//val md_theme_dark_inverseSurface = Color(0xFFE6E1E5)
//val md_theme_dark_inverseOnSurface = Color(0xFF313033)
//val md_theme_dark_inversePrimary = Color(0x80ED1D25)
val md_theme_dark_surfaceTint = Color(0xFFFFFFFF)
val md_theme_dark_outlineVariant = Color(0xFF666666)
